    ...
    for row in prange(n_rows):
        for f in range(n_chan):
            for d in range(n_dir):
                ...
                m = model[row, f, d]
                ga = gains[t_m, f_m, a1_m, d]
                gb = gains[t_m, f_m, a2_m, d]
                r = residual[row, f]
                ...
                jhr[t_m, f_m, a2_m, d, 0] += (r00*jh00 + r01*jh10)
                jhr[t_m, f_m, a2_m, d, 1] += (r00*jh01 + r01*jh11)
                jhr[t_m, f_m, a2_m, d, 2] += (r10*jh00 + r11*jh10)
                jhr[t_m, f_m, a2_m, d, 3] += (r10*jh01 + r11*jh11)
