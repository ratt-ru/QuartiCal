...
def compute_channel_coeffs_factory(corr_mode):
    ...
    applies to the delay parameters). The compute_channel_coeffs hook returns
    it as a single-element flat tuple (coeff,) which is the channel_coeffs
    tuple passed to the accumulate hook.
    """
...
reference_params = reference_params_factory(
    params_to_gains=delay_and_offset_params_to_gains,
)
