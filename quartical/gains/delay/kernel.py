...
from quartical.gains.general.rbweights_manager import update_weights
...
def delay_solver(base_args, term_args, meta_args, corr_mode):
    ...
    def impl(base_args, term_args, meta_args, corr_mode):
        ...
        for i in range(meta_args.iters):
            ...
            robust_step = i<v_niter and robust 
            ...
            if robust_step:
                v = update_weights(gains, residual, v,  weights, t_map_arr, gf_map_arr, active_term, row_map, cov_thresh, robust_thresh, corr_mode)
