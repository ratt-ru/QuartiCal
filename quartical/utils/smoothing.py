...
def gaussian_filter1d_masked(
    input_array: np.ndarray, sigma: float, mask: np.ndarray, **kwargs
) -> np.ndarray:
    """
    ...
    Args:
        ...
        mask: Boolean array of same shape as the input_array indicating valid
            values.
    ...
    # Return a smoothed version of the data which is still zero at flagged locations.
