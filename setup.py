...
if on_rtd:
    ...
    requirements = ["ruamel.yaml",
                    "numpy",
                    "dask-ms[xarray, zarr]@git+https://github.com/ska-sa/dask-ms.git@master",
                    "codex-africanus[dask, scipy, astropy, python-casacore]@git+https://github.com/ska-sa/codex-africanus.git@master",
                    "dask[array]",
                    "astro-tigger-lsm",
                    "loguru",
                    "numba",
